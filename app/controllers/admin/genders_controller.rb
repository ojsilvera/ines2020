  ...
  class GendersController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @gender.save
          format.html { redirect_to admin_gender_path(@gender), notice: 'Gender was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @gender.update(gender_params)
          format.html { redirect_to admin_gender_path(@gender), notice: 'Gender was successfully updated.' }
    ...
    def destroy
      @gender.destroy
      respond_to do |format|
        format.html { redirect_to admin_genders_path, notice: 'Gender was successfully destroyed.' }
