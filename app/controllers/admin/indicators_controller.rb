  ...
  class IndicatorsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @indicator.save
          format.html { redirect_to admin_indicator_path(@indicator), notice: 'Indicator was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @indicator.update(indicator_params)
          format.html { redirect_to admin_indicator_path(@indicator), notice: 'Indicator was successfully updated.' }
    ...
    def destroy
      @indicator.destroy
      respond_to do |format|
        format.html { redirect_to admin_indicators_url, notice: 'Indicator was successfully destroyed.' }
    ...
    private
      ...
      def indicator_params
        params.require(:indicator).permit(:description, :factor_id)
      end
  end
end
