  ...
  class PollBodiesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @poll_body.save
          format.html { redirect_to admin_poll_body_path(@poll_body), notice: 'Poll body was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @poll_body.update(poll_body_params)
          format.html { redirect_to admin_poll_body_path(@poll_body), notice: 'Poll body was successfully updated.' }
    ...
    def destroy
      @poll_body.destroy
      respond_to do |format|
        format.html { redirect_to admin_poll_bodies_url, notice: 'Poll body was successfully destroyed.' }
