  ...
  class PollHeadersController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @poll_header.save
          format.html { redirect_to admin_poll_header_path(@poll_header), notice: 'Poll header was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @poll_header.update(poll_header_params)
          format.html { redirect_to admin_poll_header_path(@poll_header), notice: 'Poll header was successfully updated.' }
    ...
    def destroy
      @poll_header.destroy
      respond_to do |format|
        format.html { redirect_to admin_poll_headers_url, notice: 'Poll header was successfully destroyed.' }
