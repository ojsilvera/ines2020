class GroupFieldsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group_field.save
        format.html { redirect_to @group_field, notice: 'Group field was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @group_field.update(group_field_params)
        format.html { redirect_to @group_field, notice: 'Group field was successfully updated.' }
  ...
  def destroy
    @group_field.destroy
    respond_to do |format|
      format.html { redirect_to group_fields_url, notice: 'Group field was successfully destroyed.' }
  ...
  private
    ...
    def group_field_params
      params.require(:group_field).permit(:detail, :group_id, :field_id, :code)
    end
end
