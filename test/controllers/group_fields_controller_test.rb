...
class GroupFieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_field" do
    assert_difference('GroupField.count') do
      post group_fields_url, params: { group_field: { detail: @group_field.detail, field_id: @group_field.field_id, group_id: @group_field.group_id, poll_header_id: @group_field.poll_header_id } }
    end
  ...
  test "should update group_field" do
    patch group_field_url(@group_field), params: { group_field: { detail: @group_field.detail, field_id: @group_field.field_id, group_id: @group_field.group_id, poll_header_id: @group_field.poll_header_id } }
