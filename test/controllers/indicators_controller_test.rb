...
class IndicatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indicator" do
    assert_difference('Indicator.count') do
      post indicators_url, params: { indicator: { detalle: @indicator.detalle, factor_id: @indicator.factor_id } }
    end
  ...
  test "should update indicator" do
    patch indicator_url(@indicator), params: { indicator: { detalle: @indicator.detalle, factor_id: @indicator.factor_id } }
