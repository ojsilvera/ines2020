...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { detail: @institution.detail, muestra: @institution.muestra, poblationTotal: @institution.poblationTotal } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { detail: @institution.detail, muestra: @institution.muestra, poblationTotal: @institution.poblationTotal } }
