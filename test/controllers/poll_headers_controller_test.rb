...
class PollHeadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll_header" do
    assert_difference('PollHeader.count') do
      post poll_headers_url, params: { poll_header: { date: @poll_header.date, edad: @poll_header.edad, gender_id: @poll_header.gender_id, group_field_id: @poll_header.group_field_id, institution_id: @poll_header.institution_id } }
    end
  ...
  test "should update poll_header" do
    patch poll_header_url(@poll_header), params: { poll_header: { date: @poll_header.date, edad: @poll_header.edad, gender_id: @poll_header.gender_id, group_field_id: @poll_header.group_field_id, institution_id: @poll_header.institution_id } }
